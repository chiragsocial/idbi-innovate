...
// Reframed around REACH + CONFIDENCE (both always favour alternate data), not a
// raw score battle (which alternate data can legitimately lose when it reveals
// risk the bureau/GST view missed).
